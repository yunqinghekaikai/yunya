						...
						<div class="am-u-sm-12 am-u-md-12">
	                  	<div class="theme-popover">														
							...
							<div class="search-content" >
								<div class="sort">
									<li class="first"><a title="综合" @click="zort">综合排序</a></li>
									<li><a title="销量" @click="count">销量排序</a></li>
									<li><a title="价格" @click="price1">价格优先</a></li>
  ...
  created(){
	...
	methods:{
		...
		count(){
	     ...
	     var val1 = obj1.quantity;
	     var val2 = obj2.quantity;
	    if(val1 > val2) {
		  return -1;
	   } else if(val1 < val2) {
		return 1;
